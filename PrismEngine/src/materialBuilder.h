...
namespace prism {
	namespace render {
		 ...
		 * - Текстуры: Albedo, Normal, Metallic, Roughness, AO, Emission
		 ...
		 *     .metallic(0, 0.8f)
		 *     .roughness(0, 0.4f)
		 *     .emission(1, "textures/light_emission.png")
		 *     .complete();
		 * @endcode
		 *
		...
		struct MaterialBuilder {
			 ...
			 *
			 * Извлекает количество материалов из MeshComponent и вызывает size().
			 *
			 * @param mesh Компонент меша, к которому применяется материал.
			 * @return Ссылка на текущий объект для цепочечных вызовов.
			 * @see MeshComponent::getMaterialCount()
			 */
			 ...
			 * @param filename Путь к файлу текстуры (относительный или абсолютный).
			 * @return Ссылка на текущий объект для цепочечных вызовов.
			 ...
			 * @param subMaterialId Индекс субматериала.
			 * @param filename Путь к одноканальной текстуре (металличность в [0;1]).
			 * @return Ссылка на текущий объект.
			 */
			 ...
			 * @return Ссылка на текущий объект.
			 * @note Значение будет ограничено clamp(0.0, 1.0) при финализации.
			 */
			 ...
			 * @param subMaterialId Индекс субматериала.
			 * @param filename Путь к одноканальной текстуре (шероховатость в [0;1]).
			 * @return Ссылка на текущий объект.
			 */
			...
			/**
			 * @brief Устанавливает скалярное значение AO для субматериала.
			 * @param subMaterialId Индекс субматериала.
			...
			/**
			 * @brief Устанавливает глобальное значение AO для всех субматериалов.
			 ...
			 * @param subMaterialId Индекс субматериала.
			 * @param filename Путь к текстуре свечения (поддерживает HDR-значения).
			 * @return Ссылка на текущий объект.
			 */
			 ...
			 *
			 * Выполняет:
			 * 1. Загрузку всех указанных текстур через TextureStorage
			 * 2. Применение глобальных и локальных скаляров (с clamp[0;1])
			 * 3. Обновление кэша хранилища текстур
			 ...
			 * @see MaterialComponent, TextureStorage::update()
			 */
