...
namespace prism {
    namespace scene {
        ...
        /// @brief ’ендл на данные в пуле
        /// @tparam DataType “ип хранимых данных (например SubMesh или SubMaterial)
        /// @tparam TagType ”никальный маркер дл€ различени€ пулов одного типа данных
